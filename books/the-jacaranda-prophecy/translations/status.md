...
| German (de) | 📝 In Review | 100% | @translator-de | 2024-02-16 |
...
- [x] Part One: The Burrow
  ...
  - [x] Chapter 2: Cooroo's Journey
- [x] Part Two: The Surface
  - [x] Chapter 3: Hoebat and Lolaboo
  - [x] Chapter 4: The Hidden Signal
...
- [x] Part One: The Burrow
  ...
  - [x] Chapter 2: Cooroo's Journey (El Viaje de Cooroo)
- [x] Backmatter (glossary, about)
...
- [x] Part One: The Burrow
  ...
  - [x] Chapter 2: Cooroo's Journey (Le Voyage de Cooroo)
- [x] Backmatter (glossary, about)
...
- [x] Part One: The Burrow
  ...
  - [x] Chapter 2: Cooroo's Journey (Cooroos Reise)
- [x] Backmatter (glossary, about)
...
1. **Draft** - Initial translation complete
2. **Review** - Native speaker review in progress
3. **Proofread** - Final proofreading pass
4. **Published** - Ready for release

## How to Contribute

1. Fork the repository
2. Create a branch for your translation: `git checkout -b translation/es-chapter-04`
