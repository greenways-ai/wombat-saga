...
**Ashground.** A narrow band of survivable temperature between fire-scorched south and frozen north. Houses on wheels. Children expert at quick disassembly, no pride in it anymore — just competence. A goanna elder singed on one side and frost-bitten on the other.

**Villager:** The goanna elder. The war has been running for five generations. Nobody remembers what started it. They just know the fighting came before everything else they can remember. *Wars are easier to maintain than reasons.*
...
**"Does he know about the forty-three eggs?"**

The Serpent burned the Monitor's nursery, generations ago. Young fire, out of control. He knew he burned the nursery. He did not know it contained forty-three eggs. The Monitor never told him — she couldn't say it without wanting to end him, and then it was too late to say it without acknowledging that she'd been punishing him for something he didn't fully understand. Which made her the one who—

*Yes,* the Serpent says. *It did.*

The Serpent's fire, burning continuously for three generations, **gutters** for the first time.

**The monsters' wounds:** The Monitor carried grief and secrecy — a loss she never named to the one responsible. The Serpent carried guilt without specific knowledge. Neither had the full picture. The war ran for three generations on half-truths and the inability to say the true thing.
...
**The Yin-Yang Cosmology (Chinese)**
The foundational Chinese framework for opposing elemental forces — fire (yang) and water/cold (yin) as complementary rather than opposed, each requiring the other to exist, the whole system requiring balance. The King Brown and Monitor Queen's war is what happens when this complementarity collapses into pure opposition: the two principles trying to annihilate rather than balance each other. The village of Ashground (caught between them) exists in the space where balance used to be.

**The Hatfield-McCoy Feud / Generational Conflict**
Not mythology but structural archetype: the feud sustained past the memory of its origin, maintained by momentum rather than grievance, where the combatants have more invested in the continuation than they would gain from resolution. The Monitor's choice not to tell the Serpent about the forty-three eggs is the mechanism that preserves the feud: the true grievance is kept private, which means it can never be addressed, which means the war continues, which means the grievance remains unresolved. A feud sustained by the secrecy of its own cause.

**Antigone (Sophocles, 441 BCE)**
The conflict between two legitimate claims that each considers itself the only legitimate claim. Creon's law (the state) vs. Antigone's law (the family/divine). Neither is simply wrong; neither can acknowledge the other's claim without losing the basis for their own. The King Brown and Monitor Queen have the same structure: both have real grievances, both have turned those grievances into total positions that cannot acknowledge the other. The doctrine — *suffering is diagnostic, not moral* — is the resolution that Antigone never gets: the acknowledgment that both sides carry real pain, and that the war is not an adequate response to it.
