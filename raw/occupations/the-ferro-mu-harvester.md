# The Ferro-Mu / Harvester

*Once the Earth-Carvers who harvested roots with precision to protect the plant's "Signal." Now: the Corvée-Grunt, performing forced labor on the Wall to pay off Tally-notches. From craft to slavery.*
...
**The Rotation:** Most Corvée labor is rotating—shifts of workers moving through different tasks, different locations, spreading the burden. But the Wall is permanent. The Ferro-Mu assigned to it may spend months, even years, in the same sector, performing the same motions, watching the Wall grow incrementally toward its designed height. They know the Wall's texture better than their own burrow walls.

---

## The Sensory World

**Touch:** Static-laden substrate produces a specific sensation—not pain, exactly, but interference. The hands tingle. The paws feel distant, as if belonging to someone else. The Grout slurry is cold, slick, chemical. It dries the skin, cracks the pads, requires constant treatment with Council-provided unguents that smell of medicine and failure.

**Sound:** The Wall's construction produces its own acoustic signature—the pour's liquid rush, the setting Grout's faint whine, the rhythmic impact of tools against hardened sections. But beneath these sounds, the Ferro-Mu hears the substrate. Or rather: hears what the substrate has become. The root-networks are severed here. The Arnam is absent. The earth does not respond to digging as it should.

**Smell:** Static has a smell, or perhaps the nose interprets its interference as smell—metallic, sharp, like lightning or blood. The Grout has its chemical scent. The Ferro-Mu's own body, exhausted, produces odors of stress and exertion. The combination is the smell of the Corvée: industrial, desperate, relentless.

**Sight:** The Wall dominates vision—gray, vertical, featureless except for the construction joints that mark each pour. Above: the tunnel ceiling, sagging, weeping. Below: the trench that will become the next section's foundation. Around: other Ferro-Mu, similarly marked by labor, similarly focused on tasks that require attention but not thought.

---

## The Inversion

**What Was:** The Ferro-Mu were Earth-Carvers, practitioners of a craft that required precision, knowledge, respect for the root-networks they harvested. They understood that roots conducted Arnam, that careless cutting severed signal, that the colony's nourishment depended on their skill. They were artisans, not laborers—valued for their judgment, their technique, their capacity to read the substrate and respond appropriately.
...
**The Injury:** Common, expected, poorly treated. The Corvée provides basic medical care—sufficient to return the worker to labor, insufficient to address underlying damage. Chronic injuries accumulate. Older Ferro-Mu move differently, their bodies adapted to pain, their movements optimized around limitation. They work until they cannot. Then they are replaced.
...
**Fragments:** The occasional root-thread that responds to touch, that seems to conduct something despite the Static, that suggests the Arnam is not entirely absent. The old techniques remembered by older workers, passed surreptitiously to younger ones, performed furtively when supervisors are not watching. The specific resonance of certain Wall sections, different from the Grout's usual scream, that suggests variation in the construction.
...
*See also: [[the-great-retaining-wall]] (what they build), [[the-tally]] (what compels them), [[the-corvée]] (the system that binds them).*
